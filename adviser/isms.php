...
<div class="breadcrumb-holder">
  <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Smarty Chat </li>
    </ul>
  </div>
</div>
...
<div id="frame">
	<div id="sidepanel">
		<div id="profile">
			<div class="wrap">
				...
				<div id="expanded">
                    ...
                    <label for="twitter"><a href="gsms.php">Move to General Messages</a></label>
        ...
        <!-- For when the contact list is empty for search button -->
        <?php 
        if($gstd ==""){
        echo '<div id="search">
...
<!-- For when the contact list is filled with students -->
        <div id="contacts">
            ...
            <?php 
        if($gstd ==""){
				echo '<li class="contact active">
					<div class="wrap">
									 
						<div class="meta">
                            <p class="name">Sorry, No Students yet!!!</p>
                            <p class="preview">Ask your students to connect with...</p>
            ...
            <input type='hidden' value='$r->std_id' name='std_id'>       
                <div class='meta'>
                    ...
                    <p class='preview'>$r->reg_no 
                    <button style='background-color:rgb(50,70,90);color:white; border:none;' type='submit' name='next'><i class='fa fa-hand-pointer-o '> </i> Open </button></p>
                    </form>
                </div>
            </div>
        </li> ";
		...
		<!-- 
            ...
            <input type='hidden' value='$r->std_id' name='std_id'>       
                <div class='meta'>
                    <p class='name'>$r->surname, $r->other_names</p>
                    <p class='preview'>$r->reg_no <button style='background-color:rgb(50,70,90);' type='submit' name='next'><i class='fa fa-hand-pointer-o '></i> Open</button></p>
                    </form>
                </div>
            </div>
        </li> ";
		...
		<div id="bottom-bar">
			<button id="addcontact"><i class="fa fa-sign-in fa-fw" aria-hidden="true"></i> <span>Add contact</span></button>
	...
	<div class="content">
		<div class="contact-profile">
            ...
            <p><?php echo get("other_names","$s students_data $w std_id ='$std_id' and status='1' ");?> </p>
		...
		<div id="mess" class="messages">
			<ul>
                <!-- no chat history -->
                <?php
                 if($showcount < 1 && $showcount2 < 1){
                echo '<p style="text-align:center; margin:20px;"><b>No chat history yet...</b></p>';
                 }
                 else{
                     //  logic to display all sms with std
                    $show1 = fetch("SELECT s.*, f.* FROM students_data as s LEFT JOIN personal_feed as f ON f.std_id = s.std_id $w f.msg_status='1' AND s.std_id ='$std_id' AND f.adviser_id='".$_SESSION['id']."' ORDER BY f.msg_id DESC");
				...
				echo "
				<li class='replies'>
					<p>$r->message<br><span class='time_date'> $r->sent_date</span></p>
                </li>";}
                else{
                   echo "<li class='sent'>  
                <p>$r->message <span class='time_date' style='color:white;'> $r->sent_date</span></p>
                </li>
                ";}
...
<?php
                   if(isset($_POST['new_sms'])){ 
                    ...
                    if(udi("$i personal_feed (msg_id, message, std_id, adviser_id, sent_date,adviser_rate, msg_status ) values('','$sms','$std','$adviser_id',CURDATE(),'Urgent','1')"))
                    {
