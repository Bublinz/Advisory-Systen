        ...
        <div class="mesgs" id="sms">
          <div class="msg_history">
                 ...
                 <?php
                   ...
                   $show = fetch("SELECT s.*, f.* FROM students_data as s LEFT JOIN personal_feed as f ON f.std_id = s.std_id $w f.msg_status='1' AND s.std_id ='$std_id' AND f.adviser_id='".$_SESSION['id']."' ORDER BY f.msg_id DESC");
